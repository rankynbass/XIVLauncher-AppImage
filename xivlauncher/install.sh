...
sed -i "s|Exec=|Exec=$HOME/Applications/XIVLauncher.Core-latest-x86_64.AppImage|" "$HERE"/XIVLauncher-AppImage.desktop
sed -i "s|Icon=|Icon=$XDG_DATA_HOME/icons/xivlauncher-core/xivlauncher.png|" "$HERE"/XIVLauncher-AppImage.desktop
