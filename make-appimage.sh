...
cp XIVLauncher.Core.desktop AppDir/usr/share/applications/XIVLauncher.Core.desktop
ln -s AppDir/opt/xivlauncher-core/XIVLauncher.Core AppDir/usr/bin/xivlauncher 
